...
@Component({
  selector: 'app-percent-composition',
  templateUrl: './percent-composition.page.html',
  styleUrls: ['./percent-composition.page.scss'],
})
export class PercentCompositionPage implements OnInit {
  ...
  onFirstElementChange() {
    ...
    this.onFirstElementInputChange();
  }
  ...
  onSecondElementChange() {
    ...
    this.onSecondElementInputChange();
  }
  ...
  onThirdElementChange() {
    ...
    this.onThirdElementInputChange();
  }
  ...
  onFourthElementChange() {
    ...
    this.onFourthElementInputChange();
  }
  ...
  onFifthElementChange() {
    ...
    this.onFifthElementInputChange();
  }
  ...
  clearInputs() {
    ...
    this.selectedFirstElement = 'H';
    this.selectedSecondElement = 'H';
    this.selectedThirdElement = 'H';
    this.selectedFourthElement = 'H';
    this.selectedFifthElement = 'H';
