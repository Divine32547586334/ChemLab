...
@Component({
  selector: 'app-percent-ionic',
  templateUrl: './percent-ionic.page.html',
  styleUrls: ['./percent-ionic.page.scss'],
})
export class PercentIonicPage implements OnInit {
  ...
  clearInputs() {
    this.firstAtom = '';
    this.secondAtom = '';
    this.electronegativityDifference = 0;
    this.percentIonicCharacter = 0;
  }
}
